...
namespace AdvancedPeopleSystem
{
    ...
    public class CustomizableCharacter : MonoBehaviour
    {
        ...
        /// </summary>
        public CustomizableCharacter Randomize()
        {
            if (IsBaked())
                ClearBake();
        ...
        public void ApplyPrefabInPlaymode()
        {
            ...
            CustomizableCharacter customizableCharacterSystem = contentsRoot.GetComponent<CustomizableCharacter>();
            Transform[] bonesOriginal = customizableCharacterSystem.GetCharacterPart("HEAD").skinnedMesh[0].bones;

            GameObject saveGO = gameObject;

            CustomizableCharacter customizableCharacterSystemSave = saveGO.GetComponent<CustomizableCharacter>();

            Transform[] bones = customizableCharacterSystemSave.GetCharacterPart("HEAD").skinnedMesh[0].bones;
